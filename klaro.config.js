...
export const klaroConfig = {
  ...
  privacyPolicy: 'https://parastats.io/privacy',
  ...
  services: [
    {
      ...
      cookies: [
        ...
        [/^_ga.*$/, '/', 'parastatst.io'], // for the production version
        ['_gid', '/', 'parastatst.io'], // for the production version
      ],
